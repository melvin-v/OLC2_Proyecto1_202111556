...
function peg$parse(input, options) {
  ...
  var peg$f4 = function(exp) { return new Print(exp) };
  var peg$f5 = function(exp) { return new ExpresionStatement(exp) };
  ...
  var peg$f11 = function(num) { return new UnaryOperation(num, "-") };
  var peg$f12 = function() {return new Number(parseFloat(text(), 10))};
  var peg$f13 = function(exp) { return new Agrupation(exp) };
  var peg$f14 = function(id) { return new ReferenceVariable(id) };
